    ...
    <div className="container">
      <div className="row align-items-center">
        ...
        <div className="col-12 col-lg-7 text-start">
          ...
          <p>I am a full-stack web developer based out of greater Chicago. While I have always been interested in web development and coding, I finally took the initiative to switch careers in 2023 by enrolling in a full-stack web development certificate from Northwestern University.</p>
